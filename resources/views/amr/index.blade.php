                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        enctype="multipart/form-data" class="mt-4" onsubmit="return showUploadSuccessAlert()">
                                        @csrf
                                    ...
                                    <script>
                                        ...
                                        // async function showUploadSuccessAlert() {
                                        //     event.preventDefault(); // Prevent form submission
                                    
                                        //     var formData = new FormData(document.querySelector('form'));
                                    
                                        //     try {
                                        //         var response = await fetch("{{ route('Amr.import') }}", {
                                        //             method: "POST",
                                        //             body: formData
                                        //         });
                                        ...
                                        //             }).then(function () {
                                        //                 window.location.href = "{{ route('amr.index') }}"; // Redirect to the upload form
                                        //             });
                                        //         } else {
                                        //             Swal.fire({
                                        //                 title: "Error",
