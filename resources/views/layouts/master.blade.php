            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        <li class="nav-item"><a href="/" :active="request()->routeIs('dashboard')"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>
                        
                        @if(Auth::check() && Auth::user()->id == 1)
                            <li class="nav-item"><a href="users" :active="request()->routeIs('users')"><i class="icon-user"></i><span data-i18n="" class="menu-title">Data User</span></a></li>
                        @endif
                        
                        <li class="nav-item"><a href="gantimeter" :active="request()->routeIs('gantimeter')"><i class="icon-speedometer"></i><span data-i18n="" class="menu-title">Ganti Meter</span></a></li>
                        <li class="nav-item"><a href="tigaphasa" :active="request()->routeIs('tigaphasa')"><i class="icon-graph"></i><span data-i18n="" class="menu-title">TigaPhasa</span></a></li>
                        <li class="nav-item"><a href="lbkb" :active="request()->routeIs('lbkb')"><i class="icon-layers"></i><span data-i18n="" class="menu-title">LBKB</span></a></li>
                        <li class="nav-item"><a href="amr" :active="request()->routeIs('amr')"><i class="ft-file-text"></i><span data-i18n="" class="menu-title">AMR</span></a></li>
                    </ul>
                    ...
                    <div id="navbarSupportedContent" class="collapse navbar-collapse">
                        ...
                        {{ Auth::user()->name }}
                                ...
                                <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu text-left dropdown-menu-right">
                                    ...
                                    <a href="{{ route('profile.show') }}"  class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>Edit Profile</span></a>
